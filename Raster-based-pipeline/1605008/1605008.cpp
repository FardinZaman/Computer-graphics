...
void z_buffer_algorithm()
{
    ...
    for(it2 = triangles_projected.begin() ; it2 != triangles_projected.end() ; ++it2)
    {
        ...
        else
        {
            ...
            int row_no_rounded = ceil(row_no);
        ...
        else
        {
            ...
            //int row_no_rounded = round(row_no);
            int row_no_rounded = floor(row_no);
        ...
        for(current_row = start_row ; current_row <= end_row ; current_row++)
        {
            ...
            else
            {
                ...
                //int column_no_rounded = floor(column_no);
...
void print_triangles()
{
    ...
    for(it = triangles.begin() ; it != triangles.end() ; ++it)
    {
        ...
        output<<now.first_point.x<<" "<<now.first_point.y<<" "<<now.first_point.z<<endl;
        output<<now.second_point.x<<" "<<now.second_point.y<<" "<<now.second_point.z<<endl;
        output<<now.third_point.x<<" "<<now.third_point.y<<" "<<now.third_point.z<<endl;
